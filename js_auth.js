...
async function handleLogin() {
    ...
    try {
        ...
        const { error } = await supabase.auth.signInWithOtp({
            email: email,
            options: {
                emailRedirectTo: "https://jeyaram1023.github.io/StreetR-customer-app-/", // or index.html if that’s your main page // This now correctly redirects back to the current page
            },
        });
